...
class TransformerLayer(GraphableMegatronModule, BaseTransformerLayer):
    ...
    def forward(self, *args, **kwargs):
        ...
        """
        with torch.autograd.profiler.record_function("Attn_top"):
            hidden_states, context = self._forward_attention(*args, **kwargs)
        with torch.autograd.profiler.record_function("MLP_top"):
    ...
    def _forward_mlp(
        ...
        with torch.autograd.profiler.record_function("PreNorm_mlp"):
