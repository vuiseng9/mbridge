        ...
        def custom_forward(hidden_states, intermediate_tensors=None, padding_mask=None):
            try:
                if "route" in self.fwd_execution_map:
                    ...
                    with torch.autograd.profiler.record_function("moe_route"):
                        probs, routing_map = self.route(hidden_states, padding_mask)
                    with torch.autograd.profiler.record_function("moe_preprocess"):
            ...
            if "expert_compute" in self.fwd_execution_map:
                ...
                with torch.autograd.profiler.record_function("moe_compute"):
            ...
            if "postprocess" in self.fwd_execution_map:
                ...
                with torch.autograd.profiler.record_function("moe_postprocess"):
